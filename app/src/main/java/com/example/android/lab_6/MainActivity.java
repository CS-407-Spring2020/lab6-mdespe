...
public class MainActivity extends FragmentActivity {
    ...
    private final LatLng mDestinationLatLng = new LatLng(43.075241, -89.404132);
        ...
        if (permission == PackageManager.PERMISSION_DENIED) {
            ...
            mfusedLocationProviderClient.getLastLocation().addOnCompleteListener(this, task -> {
                ...
                if (task.isSuccessful() && mLastKnownLocation != null) {
                    ...
                    LatLng mCurrentLatLong = new LatLng(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude());
                    mMap.addMarker(new MarkerOptions().position(mCurrentLatLong).title("Current"));
